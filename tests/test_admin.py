...
from flasktest.models import Post, Category, Link, Comment
...
class AdminTestCase(BaseTestCase):
    ...
    def setUp(self):
        ...
        post = Post(title='Hello', category=category, body='Welcome')
    ...
    def test_new_link(self):
        ...
        self.assertIn('Hello,Friend', data)
    ...
    def test_blog_setting(self):
        ...
        self.assertIn('Virtual Reality Blog', data)

        response = self.client.get(url_for('admin.settings'))
        data = response.get_data(as_text=True)
        self.assertIn('Tong Sun', data)
        self.assertIn('Virtual Reality Blog', data)
